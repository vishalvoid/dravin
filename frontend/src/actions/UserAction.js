...
export const loadUserAction = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get("https://uninterested-bear-galoshes.cyclic.app/api/v1/me", {});
...
export const logoutUser = () => async (dispatch) => {
  try {
    ...
    await axios.get("https://uninterested-bear-galoshes.cyclic.app/api/v1/logout");
